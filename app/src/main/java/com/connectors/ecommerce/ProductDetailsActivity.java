package com.connectors.ecommerce;
...
import com.connectors.ecommerce.Model.Products;
import com.connectors.ecommerce.Prevalent.Prevalent;
    ...
    private void CheckOrderState()
    {
        ...
        ordersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                if(Objects.equals(shippingState, "Shipped"))
                {
                    state = "Order Shipped";
                }
                else if (Objects.equals(shippingState, "Not Shipped"))
                {
                    state = "Order Placed";
                }
            }
